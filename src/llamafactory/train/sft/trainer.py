...
from ...data.data_utils import preprocess_sp_qwen25_vl
...
class CustomSeq2SeqTrainer(Seq2SeqTrainer):
    ...
    def training_step(self, model, inputs, *args, **kwargs):
        ...
        if not self._has_dummy_forwarded and model.module.sequence_parallel_group is not None:
            model.eval()
            with torch.no_grad():
                _ = model(**inputs)
                model.train()
    ...
    def compute_loss(self, model, inputs, return_outputs=False, **kwargs):
        ...
        """
        if model.module.sequence_parallel_group is None:  # no sequence parallel, compute as it is
            ...
            sp_group = model.module.sequence_parallel_group
