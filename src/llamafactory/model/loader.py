...
def load_tokenizer(model_args: "ModelArguments") -> "TokenizerModule":
    ...
    # token_name = "bigcode/starcoder"
    token_name = model_args.model_name_or_path
    try:
    ...
    # Add COBOL reserved words to tokenizer vocabulary
    _repo_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
    cobol_words_path = os.path.join(_repo_root, "cobol_reserved_words.txt")
    if os.path.exists(cobol_words_path):
        with open(cobol_words_path, "r") as f:
            reserved_word = [line.rstrip() for line in f]
        new_tokens = set(reserved_word) - set(tokenizer.vocab.keys())

    patch_tokenizer(tokenizer, model_args)
    try:
        processor = AutoProcessor.from_pretrained(token_name, **init_kwargs)
